...
| op | n | NumPy (ms) | MatLua Rust (ms) | MatLua Lua (ms) |
| --- | ---: | ---: | ---: | ---: |
| cholesky | 64 | 0.019021 | 0.015014 | 0.016070 |
| cholesky | 256 | 0.918903 | 0.664954 | 0.683154 |
| cholesky | 1024 | 27.072 | 23.034 | 25.163 |
| mean | 64 | 0.006348 | 0.000343 | 0.000459 |
| mean | 256 | 0.040163 | 0.007671 | 0.007908 |
| mean | 1024 | 0.685621 | 0.344896 | 0.306600 |
| median | 64 | 0.014753 | 0.003520 | 0.003730 |
| median | 256 | 0.098346 | 0.148239 | 0.054543 |
| median | 1024 | 1.8511 | 1.2723 | 1.2777 |
| norm | 64 | 0.002569 | 0.001454 | 0.001514 |
| norm | 256 | 0.007847 | 0.021936 | 0.022160 |
| norm | 1024 | 0.170236 | 0.456277 | 0.466290 |
| qr | 64 | 0.109210 | 0.288169 | 0.251422 |
| qr | 256 | 5.4400 | 4.0152 | 3.9811 |
| qr | 1024 | 124.652 | 86.830 | 78.780 |
| quantile | 64 | 0.049588 | 0.004203 | 0.004248 |
| quantile | 256 | 0.221952 | 0.158826 | 0.065245 |
| quantile | 1024 | 3.4691 | 1.4103 | 1.4707 |
| solve | 64 | 0.031368 | 0.074417 | 0.121458 |
| solve | 256 | 0.686103 | 1.2266 | 1.1379 |
| solve | 1024 | 26.545 | 35.246 | 29.087 |
| std | 64 | 0.017970 | 0.003109 | 0.003204 |
| std | 256 | 0.123747 | 0.051356 | 0.051594 |
| std | 1024 | 2.5660 | 1.0998 | 1.1572 |
...
| op | n | NumPy | Rust/NumPy | Lua/NumPy | Lua/Rust |
| --- | ---: | ---: | ---: | ---: | ---: |
| cholesky | 64 | 1.00x | 0.79x | 0.84x | 1.07x |
| cholesky | 256 | 1.00x | 0.72x | 0.74x | 1.03x |
| cholesky | 1024 | 1.00x | 0.85x | 0.93x | 1.09x |
| mean | 64 | 1.00x | 0.05x | 0.07x | 1.34x |
| mean | 256 | 1.00x | 0.19x | 0.20x | 1.03x |
| mean | 1024 | 1.00x | 0.50x | 0.45x | 0.89x |
| median | 64 | 1.00x | 0.24x | 0.25x | 1.06x |
| median | 256 | 1.00x | 1.51x | 0.55x | 0.37x |
| median | 1024 | 1.00x | 0.69x | 0.69x | 1.00x |
| norm | 64 | 1.00x | 0.57x | 0.59x | 1.04x |
| norm | 256 | 1.00x | 2.80x | 2.82x | 1.01x |
| norm | 1024 | 1.00x | 2.68x | 2.74x | 1.02x |
| qr | 64 | 1.00x | 2.64x | 2.30x | 0.87x |
| qr | 256 | 1.00x | 0.74x | 0.73x | 0.99x |
| qr | 1024 | 1.00x | 0.70x | 0.63x | 0.91x |
| quantile | 64 | 1.00x | 0.08x | 0.09x | 1.01x |
| quantile | 256 | 1.00x | 0.72x | 0.29x | 0.41x |
| quantile | 1024 | 1.00x | 0.41x | 0.42x | 1.04x |
| solve | 64 | 1.00x | 2.37x | 3.87x | 1.63x |
| solve | 256 | 1.00x | 1.79x | 1.66x | 0.93x |
| solve | 1024 | 1.00x | 1.33x | 1.10x | 0.83x |
| std | 64 | 1.00x | 0.17x | 0.18x | 1.03x |
| std | 256 | 1.00x | 0.42x | 0.42x | 1.00x |
| std | 1024 | 1.00x | 0.43x | 0.45x | 1.05x |
